/* =========================================================
   generate-audio.cjs — Vi-Jon Onboarding Portal audio
   Spark Companies
...
const SAMPLE_TEXT_EN = `Welcome to Vi-Jon orientation. Safety rules are written to protect everyone. They are not optional, and they apply to everyone equally. When you are near a forklift: stop, make eye contact with the driver, and wait for the driver's signal.`;
const SAMPLE_TEXT_ES = `Bienvenido a la orientación de Vi-Jon. Las reglas de seguridad están escritas para proteger a todos. No son opcionales y se aplican a todos por igual.`;
...
'neo0': `Safety Culture. All associates shall adhere to all safety policies established at Vi-Jon. Safety rules are written to protect everyone. They are not optional, and they apply to everyone equally. Everyone is authorized to bring safety concerns to any supervisor, any manager, any safety committee member — they wear the red bump caps — or the E H S and Sustainability team.`,
...
'cgmp': "The C G M P Question Bank. The test draws from these questions. Question 1. Where are SOPs found? The answer: On the Corporate Intranet, Vern. Question 2. When can Ditto Marks be used? The answer: Never. Question 3. Who is responsible for cleaning? The answer: Everyone. Question 4. A product with an active ingredient in its finished form is a? The answer: Drug Product. Question 5. When should a line clearance be performed? The answer: For all packaging changes. Question 6. Who regulates G M Ps? The answer: The F D A. Question 7. When can an F D A inspector visit our plants? The answer: At any time. Question 8. What three things can the F D A do to us if we do not comply? The answer: Citation, recall, or plant shutdown. Question 9. Eighty percent of most recalls are caused by? The answer: Labeling errors. Question 10. Who is responsible for C G M P? The answer: Everyone. Question 11. What is an active ingredient? The answer: An ingredient that has a direct effect on an individual's body. Question 12. What does F D A stand for? The answer: Food and Drug Administration. Question 13. Correct documentation gives us? The answer: Traceability in case there is a recall on the product. Question 14. What colors of ink should be used to fill out documentation? The answer: Blue or black. Question 15. What is one of the best areas for bacteria to grow? The answer: Standing water. Question 16. What does FIFO stand for? The answer: First in, first out. Question 17. What is the difference between our drug products and our cosmetics? The answer: A drug product contains an active ingredient that has a direct effect on a person's body. Question 18. What should you do if someone asks you to verify and sign for a step you did not witness? The answer: Don't sign the paperwork. Question 19. What is the correct way to correct a mistake on your paperwork? The answer: Draw a single line through the mistake, initial and date the correction, and add an explanation if necessary. Question 20. How far from the wall should pallets be stored? The answer: Eighteen inches. Question 21. What items are removed from the line during a line clearance? The answer: The previous packaging materials, labels, and product. Question 22. What two things can help control contamination? The answer: Facility design, and cleaning and sanitation. Question 23. What should be removed immediately from the line after use? The answer: The mop and bucket. Question 24. Name two things that can lead to contamination. The answer: Open doors and wooden pallets. Question 25. What does the c stand for in C G M P? The answer: Current. Question 26. What should you remove before entering the manufacturing area? The answer: Your jewelry. Question 27. What should you put on before entering the manufacturing area? The answer: A hairnet. Question 28. What food is allowed in the manufacturing area? The answer: None. Question 29. What should you wear to work every day? The answer: Your clean uniform, or clean temp agency shirt. Question 30. What should you do immediately after using the rest room? The answer: Wash your hands.",
