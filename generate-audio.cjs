...
'cgmp': `C G M P Training. C G M P stands for current Good Manufacturing Practices — F D A rules that govern how drug products are made. Everyone is responsible for C G M P, not just quality assurance or management. Everyone is also responsible for cleaning. A drug product contains an active ingredient — an ingredient that has a direct effect on a person's body. A product with an active ingredient in its finished form is a drug product. Cosmetics do not contain active ingredients. An F D A inspector can visit our plants at any time — no appointment needed. If we don't comply, the F D A can issue a citation, force a recall, or shut the plant down. Standard operating procedures are found on the corporate intranet — follow them exactly. Wash your hands immediately after using the restroom. Wear a clean uniform or clean agency shirt every day. Put on a hairnet before entering manufacturing, and remove your jewelry. Standing water is one of the best places for bacteria to grow. Facility design, plus cleaning and sanitation, control contamination. Never sign for a step you did not witness. To correct a mistake: draw a single line through it, initial and date the correction, and add an explanation if needed. Never use white-out, and never scribble it out. Correct documentation gives us traceability if a product is ever recalled. Eighty percent of recalls are caused by labeling errors. A line clearance is performed for all packaging changes.`,
